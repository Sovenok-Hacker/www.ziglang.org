...
Вполне возможно оценить Zig с помощью одного из выпусков, но если вы решите, что вам нравится Zig и вы
...
Для всей системы (PowerShell **с правами администратора**):
```
...
```
#### Linux
Zig также присутствует во репозиториях многих пакетных менеджеров для Linux. [Здесь](https://github.com/ziglang/zig/wiki/Install-Zig-from-a-Package-Manager)
...
Некоторые предоставляют её "из коробки", для других же потребуется установка расширения.
